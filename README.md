...
| --- | --- |
| Leave Tissot on | Mercator circles stay round and swell toward the poles; Equal Earth ellipses stay similar in area |
...
- **Equal-area** Equal Earth: country sizes comparable; shapes flex
...
```
src/lib/projections.ts   Mercator / Equal Earth, view fitting, spherical area
...
docs/ARCHITECTURE.md     How the two canvases stay in sync
